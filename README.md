...
```
> **Note:** The `TAG` must be a valid semantic version (e.g., `v0.2.2`). OLM does not support tags like `latest` for bundle versions. Use an unreleased version tag to build with the latest code.
